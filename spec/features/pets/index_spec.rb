...
RSpec.describe "the pets index" do
  ...
  xit "has a link to start an application when I clikc this link then I am taken to the new application where I see a form. Once I submit it I am taken to a completed page" do
